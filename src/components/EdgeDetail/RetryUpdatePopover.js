...
import apiWithToast from '../../Utilities/apiWithToast';
    ...
    <div>
        {reason === FAILURE
            ...
            : reason === TIMEOUT
                ...
                : status === UNRESPONSIVE
                    ? 'The service could not be reached via RHC. The system may communicate at a later time if\
                     this is a network issue or could be an indication of a more significant problem.'
                    : 'Unknown'}
